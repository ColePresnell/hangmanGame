...
//var letters = [];
//10 strings in wordbank, probably
var wordBank =
  [
    "emmitt smith",
    "troy aikman",
...
function updateDisplay() {
  ...
  document.getElementById("currentWord").innerText = guesssedWordText;
...
// checks for a win by seeing if there are remaining underscores in the guessedWord
function checkWin() {
